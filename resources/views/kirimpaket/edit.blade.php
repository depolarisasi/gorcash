@extends('layouts.app')
@section('title','Ubah Riwayat Kirim Paket - ')
@section('css')
...
<span class="card-label font-weight-bolder text-dark">Ubah Riwayat Kirim Paket</span>
</h3>
...
<form method="POST" action="{{url('kirimpaket/update')}}">
        @csrf 
