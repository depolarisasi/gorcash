...
<span class="card-label font-weight-bolder text-dark">Barcode Baru</span>
</h3>
...
<div class="tab-content">
    <form method="POST" action="{{url('barcode/store')}}">
        @csrf
          <div class="form-group row mt-4">
            <label class="col-md-2">Nama Produk <span class="text-danger">*</span></label>
            <div class="col-md-6">
            <input id="barcode_productname" type="text" class="form-control" name="barcode_productname" required>
            </div>
          </div>
          <div class="form-group row mt-4">
