...
<td>
    ...
    <button type="button" href="{{url('/barcode/delete/'.$barcode->barcode_id)}}" class="deletebtn btn btn-xs btn-icon btn-danger"><i class="fas fa-trash nopadding"></i></button></td>
