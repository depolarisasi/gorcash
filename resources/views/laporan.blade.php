...
<div id="weekchart" class="card-rounded-bottom" data-color="success" style="height: 150px"></div>
</div>
<!--end::Body-->
</div>
<!--end::Stats Widget 11-->
...
<div id="monthchart" class="card-rounded-bottom" data-color="primary" style="height: 150px"></div>
</div>
<!--end::Body-->
</div>
<!--end::Stats Widget 12-->
...
<div class="col-md-4">
    ...
    <div class="d-flex flex-column text-right">
    <span class="text-dark-75 font-weight-bolder font-size-h3">{{$weeklyproductsales}}</span>
    <span class="text-muted font-weight-bold mt-2">Barang Terjual Minggu Ini</span>
    </div>
    </div>
    <div id="productchart" class="card-rounded-bottom" data-color="warning" style="height: 150px"></div>
    </div>
    <!--end::Body-->
    </div>
    <!--end::Stats Widget 12-->
...
<script>
        ...
        var monthelement = document.getElementById("monthchart");
        ...
        var productelement = document.getElementById("productchart");
