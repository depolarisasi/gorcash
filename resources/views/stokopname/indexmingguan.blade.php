@extends('layouts.app')
@section('title','Stok Opname Mingguan - ')
@section('css')
			...
			<tbody>
				...
				<tr>
					...
					<td>
                        ...
                        @if($p->status == 0)
                    <a href="{{url('/stokopname/mingguan/'.$p->publish_groupid)}}" class="btn btn-xs btn-primary"><i class="fas fa-info-circle nopadding"></i> Lakukan Stok Opname</a>
@elseif($p->status == 2)
