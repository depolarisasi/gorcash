...
<span class="card-label font-weight-bolder text-dark">Import Band</span>
</h3>
...
<p>Import band banyak sekaligus menggunakan file Excel, gunakan <a href="{{url('asset/contoh_import.xlsx')}}">format ini</a> untuk mengimport data.</p>
<form method="POST" action="{{url('band/importing')}}" enctype="multipart/form-data">
    @csrf
    <div class="row ml-1">
                <div class="form-group row mt-5">
                  <label class="col-md-4">File Excel</label>
                  <div class="col-md-8">
                        <input  class="custom-file-input" name="band" id="fotoproduk" type="file"/>
  ...
  <div class="form-group row mt-4">
    <div class="col-md-6">
<button class="btn btn-md btn-primary" type="submit">Tambah Band</button>
    </div>
</div>
