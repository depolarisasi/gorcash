...
<span class="card-label font-weight-bolder text-dark">Note Baru</span>
</h3>
...
<div class="tab-content">
    <form method="POST" action="{{url('note/store')}}">
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
            <input type="hidden" name="note_date" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}">
          ...
          <div class="form-group row mt-4">
            ...
            <div class="col-md-10">
                <textarea id="noteisi" name="note_isi"></textarea>
            </div>
          </div>
      ...
      <div class="form-group row mt-4">
        <div class="col-md-6">
    <button class="btn btn-md btn-primary" type="submit">Tambah Note</button>
        </div>
    </div>
...
<script>
   tinymce.init({
            ...
            toolbar: ['styleselect fontselect fontsizeselect',
                ...
                'bullist numlist | outdent indent | blockquote subscript superscript | advlist | autolink | lists charmap | print preview | table tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol'],
