                    ...
                    <div class="col-md-4 my-2 my-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <select class="form-control" name="bulan" id="bulan">
                                <option value="1"  @if($selected_month == "1") selected="selected" @endif>Januari</option>
                                <option value="2"  @if($selected_month == "2") selected="selected" @endif>Februari</option>
                                <option value="3"  @if($selected_month == "3") selected="selected" @endif>Maret</option>
                                <option value="4"  @if($selected_month == "4") selected="selected" @endif>April</option>
                                <option value="5"  @if($selected_month == "5") selected="selected" @endif>Mei</option>
                                <option value="6"  @if($selected_month == "6") selected="selected" @endif>Juni</option>
                                <option value="7"  @if($selected_month == "7") selected="selected" @endif>Juli</option>
                                <option value="8"  @if($selected_month == "8") selected="selected" @endif>Agustus</option>
                                <option value="9"  @if($selected_month == "9") selected="selected" @endif>September</option>
                                <option value="10"  @if($selected_month ==  "10") selected="selected" @endif>Oktober</option>
                                <option value="11"  @if($selected_month ==  "11") selected="selected" @endif>November</option>
                                <option value="12"  @if($selected_month ==  "12") selected="selected" @endif>Desember</option>
...
<th><span class="text-dark-75">Masuk</span></th>
<th><span class="text-dark-75">Libur</span></th>
<th><span class="text-dark-75">Cuti</span></th>
<th><span class="text-dark-75">Izin </span></th>
...
<th><span class="text-dark-75">Lembur</span></th>
</tr>
</thead>
<tbody>
