...
<span class="card-label font-weight-bolder text-dark">Agenda Baru</span>
</h3>
...
<div class="tab-content">
    <form method="POST" action="{{url('agenda/store')}}">
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
            <input type="text" class="form-control" name="agenda_judul"  required autofocus>
            </div>
          </div>
          <div class="form-group row mt-4">
            <label class="col-md-2">Isi Keterangan</label>
            <div class="col-md-10">
              <textarea id="agendaisi" name="agenda_isi"></textarea>
            </div>
          </div>
          <div class="form-group row mt-4">
            <label class="col-md-2">Tanggal Mulai Agenda</label>
            <div class="col-md-3">
            <input type="date" class="form-control" name="agenda_startdate">
            </div>
          </div>
          <div class="form-group row mt-4">
            <label class="col-md-2">Tanggal Akhir Agenda</label>
            <div class="col-md-3">
            <input type="date" class="form-control" name="agenda_enddate">
            </div>
          </div>
      ...
      <div class="form-group row mt-4">
        <div class="col-md-6">
    <button class="btn btn-md btn-primary" type="submit">Tambah Agenda</button>
        </div>
    </div>
