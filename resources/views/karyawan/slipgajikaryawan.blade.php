...
<span class="card-label font-weight-bolder text-dark">Slip Gaji Saya</span>
</h3>
...
<td>
    <a href="{{url('profil-karyawan/gaji/detail/'.$k->slipgaji_id)}}" class="btn btn-xs btn-icon btn-primary"><i class="fas fa-info-circle nopadding"></i></a>
    <a href="{{url('profil-karyawan/gaji/print/'.$k->slipgaji_id)}}" class="btn btn-xs btn-icon btn-secondary"><i class="fas fa-print nopadding"></i></a>
    <a href="{{url('profil-karyawan/gaji/pdf/'.$k->slipgaji_id)}}" class="btn btn-xs btn-icon btn-success"><i class="fas fa-file-pdf nopadding"></i></a> </td>
</td>
</tr>
@endforeach
</tbody>
