        ...
        <div class="login-signin">
            ...
            <input type="hidden" name="token" value="{{ $request->route('token') }}">
                ...
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" type="email" name="email" :value="old('email', $request->email)" required autofocus />
                </div>
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" type="password" name="password" required />
                </div>
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" type="password" name="password_confirmation" required />
                </div>
                <button type="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Reset Password</button>
            </form>
        </div>
