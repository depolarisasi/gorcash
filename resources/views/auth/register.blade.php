        ...
        <div class="login-signin">
            ...
            <form class="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" placeholder="Name" type="text" name="name" :value="old('name')" required autofocus/>
                </div>
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" placeholder="Email"  type="email" name="email" :value="old('email')" required>
                </div>
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" placeholder="Password" type="password" name="password" required autocomplete="new-password" />
                </div>
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" placeholder="Confirm Password" type="password" name="password_confirmation" required />
                </div>
                <button id="kt_login_signin_submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Register</button>
            </form>
        </div>
