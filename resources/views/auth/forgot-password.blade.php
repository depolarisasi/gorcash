        ...
        <div class="login-signin">
            ...
            <form class="form" method="POST" action="{{ route('password.email') }}">
                ...
                <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" type="email" name="email" :value="old('email')" required autofocus/>
                </div>
                <button type="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Send Reset Password Link</button>
            </form>
        </div>
