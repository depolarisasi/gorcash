...
<span class="card-label font-weight-bolder text-dark">Daftar Pengajuan Dana</span>
</h3>
<div class="card-toolbar">
<a href="{{url('pengajuandana/new')}}" class="btn btn-primary btn-md font-size-sm"><i class="fas fa-plus"></i> Tambah</a>
</div>
</div>
<!--end::Header-->
...
<div class="mb-7">
	<div class="row align-items-center">
		<div class="col-lg-8 col-xl-8">
            <form method="get" action="{{url('pengajuandana')}}">
			<div class="row align-items-center">
...
<th style="min-width: 100px">Total Pengajuan</th> 
...
<td class="pl-3 py-3">
<div class="d-flex align-items-center">
  {{$p->pengajuandana_bulan}} ({{$p->pengajuandana_tahun}})
</div>
</td>
<td class="pl-3 py-3">
<div class="d-flex align-items-center">
  Rp  @money($p->pengajuandana_thp)
</div>
</td>
<td>
    <a href="{{url('/pengajuandana/detail/'.$p->pengajuandana_id)}}" class="btn btn-xs btn-icon btn-primary"><i class="fas fa-info-circle nopadding"></i></a>
    <a href="{{url('/pengajuandana/print/'.$p->pengajuandana_id)}}" class="btn btn-xs btn-icon btn-secondary"><i class="fas fa-print nopadding"></i></a>
    <a href="{{url('/pengajuandana/edit/'.$p->pengajuandana_id)}}" class="btn btn-xs btn-icon btn-warning"><i class="fas fa-edit nopadding"></i></a>
    <a href="{{url('/pengajuandana/pdf/'.$p->pengajuandana_id)}}" class="btn btn-xs btn-icon btn-success"><i class="fas fa-file-pdf nopadding"></i></a>
    <button type="button" href="{{url('/pengajuandana/delete/'.$p->pengajuandana_id)}}" class="deletebtn btn btn-xs btn-icon btn-danger"><i class="fas fa-trash nopadding"></i></button></td>
</td>
</tr>
@endforeach
</tbody>
