...
<p>Import type banyak sekaligus menggunakan file Excel, gunakan <a href="{{url('asset/contoh_import.xlsx')}}">format ini</a> untuk mengimport data.</p>
<form method="POST" action="{{url('type/importing')}}" enctype="multipart/form-data">
    @csrf
    <div class="row ml-1">
                <div class="form-group row mt-5">
                  <label class="col-md-4">File Excel</label>
                  <div class="col-md-8">
                        <input  class="custom-file-input" name="type" id="fotoproduk" type="file"/>
