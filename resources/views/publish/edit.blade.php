		...
		<table class="table table-bordered mt-5" id="product">
			...
			<tbody>
				...
				<tr>
                    ...
                    <td><input type="number" class="form-control stokinput" min="0" id="stok{{$p->product_sku}}" data-sku="{{$p->product_sku}}" name="product_stok[]" value="{{$p->publish_stok}}" @if(Auth::user()->role != 1 || Auth::user()->role != 5) readonly @endif></td>
                    <td><input type="number" class="form-control stokakhirinput" min="0"  id="stokakhir{{$p->product_sku}}" data-sku="{{$p->product_sku}}" name="product_stokakhir[]" value="{{$p->publish_stokakhir}}"  @if(Auth::user()->role != 1 || Auth::user()->role != 5) readonly @endif ></td>
