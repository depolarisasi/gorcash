...
class StokOpnameController extends Controller
{
    ...
    public function laporanpdf($pubgroup){
        ...
        ->join('size','size.size_id','product.product_idsize')
        ->select('stokopname.*','product.product_foto','product.product_id','product.product_hargajual','product.product_nama','product.product_stok','product.product_stokakhir','size.size_nama','product.product_mastersku','product.product_sku')
        ->where('stokopname.so_pubgroupname',$pubgroup)
    ...
    public function laporan($pubgroup)
    {
        ...
        ->join('size','size.size_id','product.product_idsize')
        ->join('band','band.band_id','product.product_idband')
        ->select('stokopname.*','product.product_foto','band.band_id','band.band_nama','product.product_hargajual','product.product_id','product.product_nama','product.product_stok','product.product_stokakhir','size.size_id','size.size_nama','product.product_mastersku','product.product_sku')
        ->where('stokopname.so_pubgroupname',$pubgroup)
        ->orderBy('product.product_nama','ASC')
